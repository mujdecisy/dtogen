    ...
    def write(self):
        ...
        for file in files_to_write:
            comment_lines = '\n\n' + '\n'.join([
                ...
                self.generate_comment(f"source > {self.dto_gen_info.name}:{self.dto_gen_info.version}")
            ])
            with open(f'{self.args.output_dir}/{file.file_name}.{self.get_extension()}', 'w') as f:
